...
function P(r, t) {
  return Object.is(r, t) ? !0 : typeof r != "object" || r === null || typeof t != "object" || t === null || Object.getPrototypeOf(r) !== Object.getPrototypeOf(t) ? !1 : w(r) && w(t) ? T(r) && T(t) ? j(r, t) : D(r, t) : j(
...
const R = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1 }, b = /* @__PURE__ */ new Map(), _ = (r) => {
  const t = b.get(r);
  ...
  return b.set(o.name, n), { type: "tracked", store: r, ...n };
}, J = (r, t) => {
  if (t === void 0) return;
  const o = b.get(r);
  o && (delete o.stores[t], Object.keys(o.stores).length === 0 && b.delete(r));
}, M = (r) => {
  var t, o;
  if (!r) return;
  const e = r.split(`
`), n = e.findIndex(
  ...
  let y;
  try {
    y = (i ?? (R ? "production" : void 0) !== "production") && window.__REDUX_DEVTOOLS_EXTENSION__;
  } catch {
  }
  if (!y)
    return r(o, e, n);
  const { connection: a, ...h } = k(l, y, d);
  let S = !0;
  n.setState = ((s, f, c) => {
    const u = o(s, f);
    if (!S) return u;
    const p = c === void 0 ? {
      type: v || M(new Error().stack) || "anonymous"
    } : typeof c == "string" ? { type: c } : c;
    return l === void 0 ? (a?.send(p, e()), u) : (a?.send(
      {
        ...p,
        type: `${l}/${p.type}`
      },
  ...
  if (h.type === "untracked" ? a?.init(g) : (h.stores[h.store] = n, a?.init(
    ...
    const f = n.dispatch;
    n.dispatch = (...c) => {
      (R ? "production" : void 0) !== "production" && c[0].type === "__setState" && !s && (console.warn(
    ...
    switch (s.type) {
      ...
      case "DISPATCH":
        switch (s.payload.type) {
          case "RESET":
            return m(g), l === void 0 ? a?.init(n.getState()) : a?.init(_(d.name));
          case "COMMIT":
            if (l === void 0) {
              a?.init(n.getState());
              return;
            }
            return a?.init(_(d.name));
          case "ROLLBACK":
            return I(s.state, (c) => {
              if (l === void 0) {
...
const E = (r) => (t) => {
      ...
      if (u)
        if (typeof u.version == "number" && u.version !== i.version) {
          if (i.migrate) {
            ...
            return p instanceof Promise ? p.then((O) => [!0, O]) : [!0, p];
          }
          console.error(
  ...
  const [r] = $((t, o) => ({
    ...
    async executeQueryFn({ queryFn: e, queryFnFail: n, queryFnSuccess: i }) {
      let v;
      const { setPending: l, setError: d, setData: y } = o();
      try {
        l(!0), d(null), v = await e(), y(v), typeof i == "function" && i(v);
      } catch (a) {
